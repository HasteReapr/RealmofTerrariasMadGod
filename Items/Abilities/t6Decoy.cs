...
{
	public class t6Decoy : ModProjectile
	{
 ...
 *         public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		...
		{
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, mod.ProjectileType("t6DecoyStationary"), 0, 0f, projectile.owner, 0f, 0f); //32 stands for damage
		}
