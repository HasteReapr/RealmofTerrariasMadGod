...
{
    public class t6Scepter : AncientCostFunction
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Scepter of Storms");
            Tooltip.SetDefault("A scepter that channels storms to attack foes.");
        }
        ...
        {
            Projectile.NewProjectile(player.Center, Main.MouseWorld * 16, ModContent.ProjectileType<Scepter_Projectile>(), item.damage, 0, player.whoAmI, 5);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<t5Scepter>());
