...
{
    public class t3Scepter : AncientCostFunction
    {
        ...
        {
            Projectile.NewProjectile(player.Center, Main.MouseWorld * 16, ModContent.ProjectileType<Scepter_Projectile>(), item.damage, 0, player.whoAmI, 2);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<t2Scepter>());
