...
{
	public class t5Decoy : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0f, 0f, mod.ProjectileType("t5DecoyStationary"), 0, 0f, projectile.owner, 0f, 0f); //32 stands for damage
		}
	}
}