...
{
    public class t5Scepter : AncientCostFunction
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Scepter of Skybolts");
            Tooltip.SetDefault("A scepter once wielded by cloud titan generals.");
        }
        ...
        {
            Projectile.NewProjectile(player.Center, Main.MouseWorld * 16, ModContent.ProjectileType<Scepter_Projectile>(), item.damage, 0, player.whoAmI, 4);
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<t4Scepter>());
