...
namespace ROTMG_Items.Items
{
	public class Mapple : ModItem
	{
		...
		public override bool UseItem(Player player)
		{
			...
			player.GetModPlayer<ROTMGPlayer>().AttPot = 5;
			player.GetModPlayer<ROTMGPlayer>().DefPot = 5;
			player.GetModPlayer<ROTMGPlayer>().SpdPot = 5;
			player.GetModPlayer<ROTMGPlayer>().ManaPot = 10;
			...
			player.GetModPlayer<ROTMGPlayer>().GAttPot = 5;
			player.GetModPlayer<ROTMGPlayer>().GDefPot = 5;
			player.GetModPlayer<ROTMGPlayer>().GSpdPot = 5;
			player.GetModPlayer<ROTMGPlayer>().GManaPot = 10;
