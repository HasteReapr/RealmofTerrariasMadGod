...
namespace ROTMG_Items.Items.Consumables
{
	public class LifePot : ModItem
	{
		...
		public override bool CanUseItem(Player player) => player.GetModPlayer<ROTMGPlayer>().LifePot <= 9;
		public override bool UseItem(Player player)
		{
			...
			player.GetModPlayer<ROTMGPlayer>().LifePot += 1;
			return true;
		}
	}
}