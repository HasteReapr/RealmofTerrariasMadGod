...
namespace ROTMG_Items
{
	...
	/// <summary>
	/// ROTMG_ItemsConfigServer has Server-wide effects. Things that happen on the server, on the world, or influence autoload go here
	...
	public class ModConfigShowcaseDataTypes : ModConfig
	{
		...
		/*public ModConfigShowcaseDataTypes() {
			...
			itemDefinitionROTMG_Items = new ItemDefinition("Terraria GoldOre"); // EntityDefinition uses ItemID field names rather than the numbers themselves for readability.
		*/
	//}

	// The rest of this file are many other ModConfig classes that show off various UI capabilities. They have no effect on the mod and are purely teaching ROTMG_Itemss.
	...
	public class ModConfigShowcaseLabels : ModConfig
	{
		...
		// Using localization keys will help make your config readable in multiple languages. See ROTMG_ItemsMod/Localization/en-US.lang
		[Label("$Mods.ROTMG_ItemsMod.Common.LocalizedLabel")]
		[Tooltip("$Mods.ROTMG_ItemsMod.Common.LocalizedTooltip")]
		public int LocalizedLabel;

		[Label("$Mods.ROTMG_ItemsMod.Common.LocalizedLabelDynamic")]
		public int LocalizedLabelDynamic;

		// The color of the config entry can be customized. R, G, B
		[BackgroundColor(255, 0, 255)]
		public Pair pairROTMG_Items = new Pair();
		...
		[Header("$Mods.ROTMG_ItemsMod.Common.LocalizedHeader")]
		...
		public SimpleData simpleDataROTMG_Items2 = new SimpleData();
	}
	...
	public class ModConfigShowcaseDefaultValues : ModConfig
	{
		...
		[DrawTicks]
		public SampleEnum EnumROTMG_Items2;
		...
		public SampleEnum EnumROTMG_Items1 { get; set; }
	...
	public class ModConfigShowcaseSubpages : ModConfig
	{
		...
		[Header("SeparatePage ROTMG_Itemss")]
		...
		// This ROTMG_Items has multiple levels of subpages, check it out. In this ROTMG_Items, the SubConfigROTMG_Items class itself is annotated with [SeparatePage]
		[Label("Sub Config ROTMG_Items - Click me")]
		public SubConfigROTMG_Items subConfigROTMG_Items = new SubConfigROTMG_Items();

		[SeparatePage]
		public Dictionary<ItemDefinition, SubConfigROTMG_Items> DictionaryofSubConfigROTMG_Items = new Dictionary<ItemDefinition, SubConfigROTMG_Items>();

		// These 2 ROTMG_Itemss show how [SeparatePage] works on annotating both a field for a class and annotating a List of a class
		[SeparatePage]
		...
		[SeparatePage]
		public class SubConfigROTMG_Items
		{
			[DefaultValue(99)]
			public int boost = 99;
			...
			public SubSubConfigROTMG_Items SubA = new SubSubConfigROTMG_Items();

			[SeparatePage]
			[Label("Even More Sub")]
			public SubSubConfigROTMG_Items SubB = new SubSubConfigROTMG_Items();
			...
			public override bool Equals(object obj) {
				if (obj is SubConfigROTMG_Items other)
		...
		public class SubSubConfigROTMG_Items
		{
			public int whoa;
			public override bool Equals(object obj) {
				if (obj is SubSubConfigROTMG_Items other)
...
#pragma warning restore CS0414
		...
		// Will not show. Avoid static. Due to how ModConfig works, static fields will not work correctly. Use a static field named Instance in the manner used in ROTMG_ItemsConfigServer for accessing ModConfig fields in the rest of your mod.
		public static float Static;

		// Get only properties will show up, but will be grayed out to show that they can't be changed. 
		public float Getter => Main.rand?.NextFloat(1f) ?? 0; // This is just an ROTMG_Items, please don't do this.
		...
		// ShouldSerialize{FieldNameHere}. ShouldSerialize can be useful, but this ROTMG_Items is simply replicating the behavior of JSONIgnore and is just an ROTMG_Items for ROTMG_Itemss sake. https://www.newtonsoft.com/json/help/html/ConditionalProperties.htm
		public bool ShouldSerializeGetter() {
			// We can have some logic in here to determine if the value is worth saving, but this is just a trivial ROTMG_Items
			return false;
		}
	}
	...
	public class ModConfigShowcaseMisc : ModConfig {
		...
		/*
		// Here are some more ROTMG_Itemss, showing a complex JsonDefaultListValue and a initializer overriding the defaults of the constructor.
		[CustomModConfigItem(typeof(GradientElement))]
		...
		*/
		...
		// In this ROTMG_Items we inherit from a tmodloader config UIElement to slightly customize the colors.
		...
		public Pair pairROTMG_Items2 = new Pair();

		public SimpleData simpleDataROTMG_Items; // you can also initialize in the constructor, see initialization in public ModConfigShowcaseMisc() below.
		...
		public SimpleData simpleDataROTMG_Items2;
		...
		public ModConfigShowcaseMisc() {
			simpleDataROTMG_Items = new SimpleData();
			simpleDataROTMG_Items.boost = 32;
			simpleDataROTMG_Items.percent = 0.7f;
		}
		...
		internal void OnDeserializedMethod(StreamingContext context) {
			...
			// To test this, insert the following into ROTMG_ItemsMod_ModConfigShowcase.json: "OldListOfInts": [ 99, 999],
	...
	public class ClassUsedAsKey
	{
		...
		// But to get the object back, you need a TypeConverter, and this ROTMG_Items shows how to implement one

		// You start with the [TypeConverter(typeof(ToFromStringConverter<NameOfClassHere>))] attribute above the class
		// For this to work, you need the usual Equals and GetHashCode overrides as explained in the other ROTMG_Itemss,
